  ...
  function getBatteryPanel() {
    ...
    if (panel) {
      panel.panelID = {
        ...
        showQuickNixPerformance: widgetSettings.showQuickNixPerformance !== undefined ? widgetSettings.showQuickNixPerformance : widgetMetadata.showQuickNixPerformance
      };
    }
    return panel;
  }
