...
/*
QuickNix is not strictly a Material Design project, it supports both some predefined
...
Singleton {
  ...
  function adaptiveOpacity(baseOpacity) {
    if (PowerProfileService.quicknixPerformanceMode)
      return 1.0;
  ...
  // --------------------------------
  // Default colors: QuickNix (default) dark — must match Assets/ColorScheme/QuickNix-default
  QtObject {
    id: defaultColors
