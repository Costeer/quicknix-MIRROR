...
SmartPanel {
  ...
  panelContent: Item {
    ...
    readonly property real contentPreferredWidth: Math.round((Settings.data.location && Settings.data.location.showWeekNumberInCalendar ? 440 : 420) * Style.uiScaleRatio)
