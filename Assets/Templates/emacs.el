;;; quicknix-theme.el --- Theme using Template SCSS variables -*- lexical-binding: t -*-
...
(deftheme quicknix "Theme using Template variables with quality of life improvements.")
...
(provide-theme 'quicknix)
;;; quicknix-theme.el ends here
