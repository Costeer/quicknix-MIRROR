...
- **MrDowntempo** - Creator of the QuickNix Owl and moon logo
- **[SaberJ2X](https://www.reddit.com/user/SaberJ64/)** - Creator of Talia, the QuickNix mascot

## Core Framework

- **[Quickshell](https://github.com/outfoxxed/quickshell)** - The Qt/QML-based Wayland shell framework that powers QuickNix
...
- All the contributors and users who have helped make QuickNix better

## License
QuickNix Shell is licensed under the MIT License. See [LICENSE](LICENSE) for details.
