  ...
  panelContent: Item {
    ...
    Keys.onPressed: event => {
                      ...
                      if (event.key === Qt.Key_N) {
                        ...
                        inputMuteKeyHint.active = true;
                        event.accepted = true;
                        return;
                      }
                      if (event.key === Qt.Key_1) {
                        panelContent.currentTabIndex = 0;
                        tabBar.currentIndex = 0;
                        tabBtn1.activated = true;
                        event.accepted = true;
                        return;
                      }
                      if (event.key === Qt.Key_2) {
                        panelContent.currentTabIndex = 1;
                        tabBar.currentIndex = 1;
                        tabBtn2.activated = true;
                        event.accepted = true;
                        return;
                      }
                    }
        ...
        ColumnLayout {
          ...
          NTabBar {
            ...
            NTabButton {
              ...
              transform: Scale {
                id: tabBtn1Scale
                origin.x: tabBtn1.width / 2
                origin.y: tabBtn1.height / 2
                xScale: 1.0
                yScale: 1.0
              }
            ...
            NTabButton {
              ...
              transform: Scale {
                id: tabBtn2Scale
                origin.x: tabBtn2.width / 2
                origin.y: tabBtn2.height / 2
                xScale: 1.0
                yScale: 1.0
              }
              ...
              ColumnLayout {
                ...
                RowLayout {
                  ...
                  NValueSlider {
                    ...
                    onSliderPressedChanged: function (pressed) {
                  ...
                  Item {
                    width: outputMuteBtn.width
                    height: outputMuteBtn.height
                    NIconButton {
                      id: outputMuteBtn
            ...
            NBox {
              ...
              ColumnLayout {
                ...
                RowLayout {
                  ...
                  Item {
                    width: inputMuteBtn.width
                    height: inputMuteBtn.height
                    NIconButton {
                      id: inputMuteBtn
